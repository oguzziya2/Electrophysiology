...
switch element_node_number
    case 9
        N_xi(1)=1/4*(2*xi-1)*(nu-1)*nu;
        N_xi(2)=1/4*(2*xi+1)*(nu-1)*nu;
        N_xi(3)=1/4*(2*xi+1)*(nu+1)*nu;
        N_xi(4)=1/4*(2*xi-1)*(nu+1)*nu;
        
        N_xi(5)=1/2*(-2*xi)*(nu-1)*nu;
        N_xi(6)=1/2*(2*xi+1)*(1-nu.^2);
        N_xi(7)=1/2*(-2*xi)*(nu+1)*nu;
        N_xi(8)=1/2*(2*xi-1)*(1-nu.^2);
        
        N_xi(9)=(1-nu.^2)*(-2*xi);
        
        N_nu(1)=1/4*(2*nu-1)*(xi-1)*xi;
        N_nu(2)=1/4*(2*nu-1)*(xi+1)*xi;
        N_nu(3)=1/4*(2*nu+1)*(xi+1)*xi;
        N_nu(4)=1/4*(2*nu+1)*(xi-1)*xi;
        
        N_nu(5)=1/2 *(2*nu-1)*(1-xi.^2);
        N_nu(6)=1/2 *(-2*nu)*(xi+1)*xi;
        N_nu(7)=1/2 *(2*nu+1)*(1-xi.^2);
        N_nu(8)=1/2 *(-2*nu)*(xi-1)*xi;
